...
#if defined(__sun) || defined(__ULTRIX022)
#define FD_ZERO(p)  ((p)->fds_bits[0] = 0)
#define FD_SET(n, p)   ((p)->fds_bits[0] |= (1 << (n)))
#define FD_ISSET(n, p)   ((p)->fds_bits[0] & (1 << (n)))
#endif /* defined(__sun) || defined(__ULTRIX022) */

/* General definitions */
#define		KSUCCESS	0
#define		KFAILURE	255

#if defined(__ULTRIX022) || defined(__sun)
typedef unsigned short uid_t;
typedef unsigned short gid_t;
#endif	/* defined(__ULTRIX022) || defined(__sun) */
...
#define 	KRBLOG 		"/var/dss/kerberos/log/kerberos.log"
...
#define TKT_ROOT        "/var/dss/kerberos/tkt/tkt"
#endif /* PC */

/* Filename for readservkey */
#define KEYFILE		"/etc/srvtab"
#define SRVTAB_FILE     srvtab_string()
...
/* Error codes returned by krb_sendauth */
#define		SENDAUTH_OPNOTSUP	82 /* option bit not supported */
#define		SENDAUTH_WR	83	/* read error in sendauth */

/* Error codes returned by krb_recvmutual */
#define		RECVMUT_OPNOTSUP	84 /* option bit not supported */
#define		RECVMUT_RD	85	/* read error in sendauth */
#define		RECVMUT_MSGLEN	86	/* bad length for message read */

/* Error codes returned by krb_recvauth */
#define		RECVAUTH_OPNOTSUP	87 /* option bit not supported */
#define		RECVAUTH_RD	88	/* read error in sendauth */
#define		RECVAUTH_TKTLEN	89	/* bad ticket length */

/* Error codes returned by krb_sendmutual */
#define		SENDMUT_OPNOTSUP	90 /* option bit not supported */
#define		SENDMUT_WR	91	/* write error in sendmutual */
#define		SENDMUT_MAKMSG	92	/* error makeing msg in sendmutual */
#define		SENDMUT_PARAM	94	/* bad paramater passed to sendmutual*/

/* Error codes returned by krb_net_read */
#define		NETREAD_TIMEOUT	95	/* timeout during non blocking read */

/* Error codes returned by krb_net_read */
#define		NETWRITE_TIMEOUT	96 /* timeout during non blocking
					      read */
#define		KDCINIT_OPNOTSUP	97 /* operation not supported */
#define		GETAD_OPNOTSUP		98 /* operation not supported */
#define		GETIN_OPNOTSUP		99 /* operation not supported */
/*
...
#define	KOPT_USE_NBLIO	0x00000010 /* the fd send to send/recv auth is
					non blocking */
#define	KOPT_MKBLNB	0x00000020 /* the fd sent to send/recv auth is
					blocking.  Don't block on it. */

#define	KOPT_NORDWR	0x00000040 /* Do not send any data out on the net */

#define GETTKTOPT_GETFRESH 0x00000001 /* get a fresh ticket from the get_ad_tkt
				       since the old one has expired */

#define KDCINITOPT_TIMEOUT 0x00000001 
