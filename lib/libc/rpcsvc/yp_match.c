#ifndef lint
static char *sccsid = "@(#)yp_match.c	4.1      (ULTRIX)        7/3/90";
#endif lint
 ...
 *
 *	Fred L. Templin (templin@decvax) Sept. 15, 1987
 *   Removed change of Sept. 5, 1986 which caused unacceptable performance
 *   degradation. Side effect of this change leaves an open socket descriptor
 *   in the calling process's descriptor table. This can break binaries which
 *   make assumptions about the ordering of their descriptors.
 *
 ...
 *
 *	04/13/89	jhw
 *			Replaced old ypmatch with new SUN4.0 ypmatch
 *
 */
