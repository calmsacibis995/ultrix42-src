#ifndef lint
#static char	*sccsid = "@(#)d_atan2.s	4.1	(ULTRIX)	7/17/90";
#endif lint
...
pio2x:
	bicw3	$0x807f,r2,r11		# yexp
	jeql	both0			# if y=0 goto yeq0
pio2:	movq	$0x68c2a2210fda40c9,r0	# pi/2=1.5707963267948966135d1
