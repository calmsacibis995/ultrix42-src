#ifndef lint
static	char	*sccsid = "@(#)order.c	4.1	(ULTRIX)	7/3/90";
#endif lint
...
*
*	Jon Reeves, 03-May-1989 for Sid Maxwell
* 003	Reduce complex expressions in procedure calls to avoid
*	"stuck starg" messages.  Code from BSD 4.3.
* 
