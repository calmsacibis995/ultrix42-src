#ifndef lint
static	char	*sccsid = "@(#)expr.c	4.1	(ULTRIX)	7/3/90";
#endif lint
 ...
 * 10-Jan-89	Tim N
 *	Added checking for divide by 0.  Used BADCOM to signal that
 *	error for both '#' and '%' operators.  Have to flush the input
 *	buffer before calling the error routine.
 *
