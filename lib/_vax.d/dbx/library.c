 ...
 *									*
 *      002 - Added an xdb "magic cookie" to error messages if dbx has  *
 *            been called with the -x flag.				*
...
boolean xdb = FALSE;		/* xdb specific features */
