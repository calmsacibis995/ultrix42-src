 ...
 */
#ifndef lint
static char sccsid[] = "@(#)asexpr.c	4.3 ULTRIX 9/4/90";
#endif /* not lint */
...
#define clobber(val, set) tokensets[(val)] |= (set)
	...
	clobber(VINSTn,	YUKKYEXPRBEG);
	clobber(VINST0,	YUKKYEXPRBEG);
	clobber(VREG,	YUKKYEXPRBEG);
...
struct Tok_Desc tok_desc[] = {
	...
	VREG,           HUNK,   "vector register specifier",
	VINST0,         INSTR,  "0 argument vector inst",
	VINSTn,         INSTR,  "n argument vector inst",
	VMODIFIER,      HUNK,   "vector instruction modifier",
