...
#ifndef lint
static char sccsid[] = "@(#)asscan3.c	4.3 ULTRIX 9/4/90";
#endif /* not lint */
...
readonly short charsets[] = {
	...
	/* '/' 0x2f 0057 */	0,
	/* '0' 0x30 0060 */	DIGIT+REGDIGIT+OCTDIGIT+MODIFIER,
	/* '1' 0x31 0061 */	DIGIT+REGDIGIT+OCTDIGIT+MODIFIER,
	...
	/* 'S' 0x53 0123 */	ALPHA,
	/* 'T' 0x54 0124 */	ALPHA,
	/* 'U' 0x55 0125 */	ALPHA+MODIFIER,
	/* 'V' 0x56 0126 */	ALPHA+MODIFIER,
	...
	/* 'u' 0x75 0165 */	ALPHA+MODIFIER,
	/* 'v' 0x76 0166 */	ALPHA+MODIFIER,
