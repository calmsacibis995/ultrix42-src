#ifndef lint
static char	*sccsid = " @(#)wrtfmt.c	1.3	(ULTRIX)	1/16/86";
#endif lint
...
LOCAL
wrt_IM(ui,w,m,len) int_union *ui; ftnlen len;
...
wrt_L(l,width,len) int_union *l; ftnlen len;
{	int i,n;
