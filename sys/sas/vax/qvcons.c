...
#ifndef lint
static	char	*sccsid = "@(#)qvcons.c	4.1	(ULTRIX)	7/2/90";
#endif lint
/************************************************************************
 *									*
 ...
 *
 * 14 Mar 88 -- Tim Burke
 *	Provide support for 8 bit characters.
 *
 *  7 Jul 84 --  rjl
...
/* initialize with defaults, but not with sruct copy because qe structure too
 * complex, before first reference 					*/
