#ifndef lint
static char *sccsid = "@(#)if_hy.c	4.1 (ULTRIX) 7/2/90";
#endif lint
 ...
 *			Reflect V3.2 source pool changes. Also, include	*
 *			Lea's changes from 27-Jul-88 (added & typo).	*
 *									*
 * 12-Apr-88  -- lea	43.5bsd fixes					*
 *									*
