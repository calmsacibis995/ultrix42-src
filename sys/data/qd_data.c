/*
 * static	char	*sccsid = "@(#)qd_data.c	4.1	(ULTRIX)	7/2/90";
 */
...
#include "../io/uba/qdioctl.h"	/* ioctl call values */
#include "../h/tty.h"
...
#include "../io/uba/qduser.h"	/* definitions shared with my client */
#include "../io/uba/qdreg.h"	/* QDSS device register structures */
