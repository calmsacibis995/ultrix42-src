 ...
 *
 * 28-Feb-91 -- dws
 *	Cleaned up fhandle_t definition
 *
 * 02-Mar-87 -- logcher
...
typedef union {
		...
		/* export granting directory */
			u_long	eno;		/* file number */
			u_long	egen;		/* file generation */
		} svcfh;

		/* fhandle must be NFS_FHSIZE bytes in length */
		char	fh_pad[NFS_FHSIZE];
} fhandle_t;

#ifdef NFSSERVER
#define fh_fsid		svcfh.fsid
#define fh_fno		svcfh.fno
#define fh_fgen		svcfh.fgen
#define fh_eno		svcfh.eno
#define fh_egen		svcfh.egen
#endif
