...
#define ALLCONS		0x000f0000	/* Mask of all xmit enables */
...
#if defined(VAX9000)
/* RXDB ID field definitions */
#define RXDB_ID_CTY     0x00000100      /* Local console */
#define RXDB_ID_RTY     0x00000200      /* Remote console */
#define RXDB_ID_LTY     0x00000800      /* Logical console */
#define RXDB_ID_CARIER  0x00000f00      /* Carrier report */

#define RXDB_CONRTN	0x00040000	/* Console reboot indicator */
#define RXDB_RTYCD	0x00020000	/* RTY carrier detect indicator */
#define RXCS_RDTR	0x00020000	/* Raise remote DTR */

/* Bit definitions in the TXCS register */
#define TXCS_ID         0x00000f00      /* ID field */
#define TXCS_WM         0x00008000      /* Write Mask */
#define TXCS_CTY_ENA    0x00010000      /* Enable local console */
#define TXCS_RTY_ENA    0x00020000      /* Enable remote console */
#define TXCS_LTY_ENA    0x00080000      /* Enable logical tty */

/* TXCS ID field definitions */
#define TXCS_ID_CTY     0x00000100      /* Local console */
#define TXCS_ID_RTY     0x00000200      /* Remote console */
#define TXCS_ID_LTY     0x00000800      /* Logical console */
#define TXCS_NO_TTY     0x00000f00      /* No TTY selected */
#endif /* VAX9000 */

/* Commands allowed on logical console line */
