...
/* This define is put here because of a change in the C compiler.  The
 * word "const" has been added to the list of keywords, becoming a
 * declaration type.  The use of "const" in this structure definition
 * caused errors from the compiler as a result.  
 * As a quick fix, this define statement was used to avoid changing
 * the use of "const" everywhere it appears in this directory.  If, at
 * any time it becomes necessary to use the new declaration type in this
 * directory, all the occurances of "const" should be replaced with an
 * appropriate word, and this define should be removed.
 */
