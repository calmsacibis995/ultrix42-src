%{
static	char *sccsid = "@(#)bc.y	4.1	(ULTRIX)	7/17/90";
	int *getout();
%}
%right '='
%left '+' '-'
...
va_dcl
{
	...
	*(b_sp_nxt++) = 0;
	yyval = (YYSTYPE) save_space;
	return((int)save_space);
#endif mips
}
