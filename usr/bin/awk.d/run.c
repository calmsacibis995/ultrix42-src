#ifndef lint
static	char	*sccsid = "@(#)run.c	4.1	(ULTRIX)	7/17/90";
#endif
...
*
*	5/31/89	Tim N
* 004 - Added field_num field of cell record to definition of nullval.
*	Also added fix from 4.3-5 to wait before exiting if busy.
*
*************************************************************************/
