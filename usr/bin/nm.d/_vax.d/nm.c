 ...
 *									*
 *	004 - Merged 4.3 BSD changes: correct handling of N_FN,		*
 *	      better error recovery; also, add -e as synonym for -g	*
 *	      and -f as synonym for -a for minimal X/OPEN conformance.	*
 *	      (Jon Reeves, 1988 Feb 08)					*
 *									*
