#ifndef lint
static	char	*sccsid = "@(#)ypcat.c	4.3	(ULTRIX)	11/9/90";
#endif lint
 ...
 *
 * 10/30/90     terry
 *              Changed services.byport back to services.byname for 
 *              backwards compatibility with ULTRIX v4.0
 *
 * 08/30/90 	terry
 *		Changed default services map from services.byname to
 * 		services.byport, corresponding to changes made to the YP maps.
 */
