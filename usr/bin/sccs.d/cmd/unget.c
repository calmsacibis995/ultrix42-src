#ifndef lint
static	char	*sccsid = "@(#)unget.c	4.1	(ULTRIX)	7/17/90";
#endif lint
 ...
 *
 * 12-Jun-89 -- Ken Lesniak
 *	Modified "sact" to print a friendly message for files which
 *	are not currently reserved.
 *
 * 28 Jun 88 -- D. Long
 *	Use atomic rename operation in xremove instead of link and unlink.
 *	Also do error checking on fputs, fflush, and fclose's.
 */
