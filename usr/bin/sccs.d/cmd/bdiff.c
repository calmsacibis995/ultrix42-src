#ifndef lint
static	char	*sccsid = "@(#)bdiff.c	4.1 (ULTRIX) 7/17/90";
#endif lint
 ...
 *
 * 08-Jun-1989, Ken Lesniak
 *	Changed handling of errors from exec'ing diff, so that it
 *	can be distinguished from diff's successful completion status.
 */
