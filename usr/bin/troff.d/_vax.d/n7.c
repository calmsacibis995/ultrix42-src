 ...
 *
 * 31-Aug-87  David Gray (gray)
 *
 *            In procedure newline around label nl1: the test for
 *            donef was modified to (donef == 1). This allows
 *            floating keeps to be handled correctly.
 *           
 */
