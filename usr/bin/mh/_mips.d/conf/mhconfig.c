...
#ifndef	lint
static char ident[] = "@(#)$Id: mhconfig.c,v 1.2 90/11/25 18:57:25 sharpe Exp Locker: sharpe $";
#endif	lint
...
int	flag;
{
    ...
    if (strcmp (x400, "on") == 0)
	fprintf (fp, "/^@BEGIN: X400$/d\n/^@END: X400$/d\n");
    else
	fprintf (fp, "/^@BEGIN: X400$/,/^@END: X400$/d\n");
...
/*  */
    ...
    if (strcmp (x400, "on") && strcmp (x400, "off"))
	adios (NULLCP, "x400 should be either \"on\" or \"off\", not %s", x400);
    if (strcmp (x400, "on") == 0)
	add_option ("X400");
