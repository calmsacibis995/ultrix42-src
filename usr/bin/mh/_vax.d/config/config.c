...
char *options[] = {"ISI", "MHRC", "WHATNOW", "MHE", "BSD42", "BERK", "NETWORK", "BIND", "RPATHS", "DPOP", "RPOP", "FOLDPROT='\"0700\"'", "MSGPROT='\"0600\"'", "TYPESIG='void'", "POPSERVICE='\"pop\"'", "SPRINTF='int'", "SENDMTS", "SMTP", "POP", "X400", NULL};
