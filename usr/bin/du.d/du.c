#ifndef lint
static	char	*sccsid = "@(#)du.c	4.1	(ULTRIX)	7/17/90";
#endif
...
*
*	01	Lie-Min Hioe, 01-Aug-1989
*		xpg3 conformance
*		Fixed the problem of not reading the option list propeorly
*
**************************************************************************/
	...
	char **argv;
{
	...
	if (errflg) {
		fprintf(stderr, "usage: du [-as] [name ...]\n");
		exit(2);
	}
