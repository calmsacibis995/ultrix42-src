...
#ifndef lint
static	char	*sccsid = "@(#)sed0.c	4.1	(ULTRIX)    7/17/90";
#endif lint
...
*
*  	01	Lie-Min Hioe, 21-July-1989
*		Make character class regular expression operate in an
*		8-bit transparent manner.		
*		
*  	02	Lie-Min Hioe, 24-July-1989
*		Add the construction \?regular expression? for xpg3
*		conformancy.		
*		
*
************************************************************************/
