/*
 * sccsid = "@(#)sh.h	4.1	(ULTRIX)	7/17/90";
 */
/************************************************************************
 *									*
 *			Copyright (c) 1988 by				*
 ...
 *	declare "bool editline" for dcsh style cmd line edit.
 *	remove Mips file completion and tsh stuff.
 *
...
#ifdef CSHEDIT
bool	editline;		/* edit cmd line because of :v mod */
#endif
 ...
 * Characters are quoted in words using the QUOTECHAR but when manipulated
 * internally using QUOTE.
 */
#define	QUOTE 	0400		/* Eighth char bit used internally for 'ing */
#define	TRIM	0377		/* Mask to strip quote bit */
#define QUOTECHAR       0377    /* Character which indicates next is quoted */
				/* double quote character in string     */
#define DBL_QUOTE       "\377\377"

typedef unsigned short  CHTYPE;	/* type of char with quote bit  */
...
#ifndef BSD4_3
/*
 * already defined in <sys/types.h> included by <param.h> - jlr
 * typedef u_short uid_t;
 * typedef u_short gid_t;
 */
/*
 * already defined in /usr/include/sys/signal.h - gag
