#ifndef lint
static char *sccsid = "@(#)sh.exp.c	4.2  (ULTRIX)        8/13/90";
#endif
/************************************************************************
 *                                                                      *
 *                      Copyright (c) 1988 by                           *
...
/* | consent of MIPS.                                               | */
/* ------------------------------------------------------------------ */
/* $Header: sh.exp.c,v 1.4 87/04/15 08:56:53 dce Exp $ */
 ...
 *	 changed call to csh internal printf routine to csh_printf to avoid
 *	 confusion with stdio printf.
 */
