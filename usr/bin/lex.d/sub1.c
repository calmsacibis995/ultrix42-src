#ifndef lint
static char sccsid[] = "@(#)sub1.c	4.1	(Ultrix)	7/17/90";
#endif
...
#ifndef ultrix    /* these are now defined in ldefs.c */
alpha(c)
  int c; {
# ifdef ASCII
...
usescape(c)
  int c; {
	...
	return(c & CMASK); /* prevent sign extension for 8 bit */
	}
lookup(s,t)
  unsigned char *s;
  unsigned char **t; {
