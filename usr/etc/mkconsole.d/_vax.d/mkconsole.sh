#!/bin/sh
# SCCSID = @(#)mkconsole.sh	4.2	(ULTRIX)	11/14/90
# ************************************************************************
# *									*
# *			Copyright (c) 1990 by				*
...
# ~~~~~~~~~~~~~~~~~~~~ 
# 003 - Oct. 30, 1990 - Joe Szczypek
#	Add VAX6400/6500 support.
