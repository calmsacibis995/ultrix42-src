...
#define	OPset	gettyflags[2].set    /* should be gettyflags[3].set */
#define	AP	gettyflags[4].value
#define	APset	gettyflags[2].set    /* should be gettyflags[4].set */
...
#define P8	gettyflags[20].value
#define PD	gettyflags[21].value
