#ifndef lint
static	char	*sccsid = "@(#)if.c	4.4	(ULTRIX)	10/15/90";
#endif lint
 ...
 *		Changed the same(,) macro to only compare the Internet address
 *		field of a sockaddr structure.
 */
/*
#ifndef lint
static char sccsid[] = "@(#)if.c	4.4 (Berkeley) 10/15/90";
#endif not lint
*/
/*
...
#define	same(a1, a2) \
 	(bcmp( &(a1)->sa_data[2], &(a2)->sa_data[2], 4) == 0) 
