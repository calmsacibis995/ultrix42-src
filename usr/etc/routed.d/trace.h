/*
#ifndef lint
static  char    *sccsid = "@(#)trace.h	4.1  (ULTRIX)        7/2/90";
#endif lint
*/
/************************************************************************
 *									*
...
extern	int snmpdebug;		/* debug SNMP stuff */
...
#define	TRACE_TRC	if (snmpdebug) printf
#define	TRACE_EXT	if (snmpdebug) printf
#define	TRACE_UPD	if (snmpdebug) printf
