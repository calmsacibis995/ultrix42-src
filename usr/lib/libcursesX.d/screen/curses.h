 ...
 *
 * 02/07/90 GWS	replaced <sgtty.h> with <termio.h>, and replaced sgttyb with
 *		 termio in definition of SGTTY typedef, so cursesX will use
 *		 termio(4)-style terminal I/O.
 *
 */
...
/* The next three are subject to change so don't depend on them */
#define A_INVIS		0x00400000
#define A_PROTECT	0x00800000
#define A_ALTCHARSET	0x01000000

#define A_NORMAL	0x00000000
#define A_ATTRIBUTES	0xFFFF0000
#define A_CHARTEXT	0x0000FFFF
