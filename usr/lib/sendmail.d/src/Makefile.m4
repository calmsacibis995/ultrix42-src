...
OBJS1=	conf.o main.o collect.o domain.o  parseaddr.o alias.o deliver.o \
...
OBJS=	$(OBJS1) $(OBJS2)
SRCS1=	conf.h sendmail.h mailstats.h trace.h \
	conf.c deliver.c domain.c main.c parseaddr.c err.c alias.c savemail.c \
	sysexits.c util.c bmove.c arpadate.c version.c collect.c nsyslog.c \
	macro.c headers.c readcf.c stab.c recipient.c stats.c daemon.c \
	newsyslog.c usersmtp.c srvrsmtp.c queue.c clock.c trace.c envelope.c
...
O=	-O
COPTS=
CCONFIG=-I../`include' -DMXDOMAIN -DBSD4_3 -DOLDJEEVES -DVMUNIX m4CONFIG
