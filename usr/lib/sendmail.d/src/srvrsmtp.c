...
# ifndef SMTP
# ifndef lint
static char	SccsId[] = "@(#)srvrsmtp.c @(#)srvrsmtp.c	1.1 (ULTRIX) 7/17/87 (no SMTP)";
# endif not lint
# else SMTP

# ifndef lint
static char	SccsId[] = "@(#)srvrsmtp.c @(#)srvrsmtp.c	1.1 (ULTRIX) 7/17/87 (with SMTP)";
# endif not lint
...
# ifdef DEBUG
	"showq",	CMDDBGQSHOW,
# ifdef notdef
	/* We don't want this debug switch accessable via SMTP */
	"debug",	CMDDBGDEBUG,
# endif
# endif DEBUG
# ifdef WIZ
