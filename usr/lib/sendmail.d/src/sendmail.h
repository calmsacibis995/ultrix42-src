...
# define EXTERN
# ifndef lint
static char SmailSccsId[] =	"@(#)sendmail.h @(#)sendmail.h	1.2 (ULTRIX) 7/20/87";
# endif lint
# else  _DEFINE
...
# define MATCHPW	'\016'	/* match token in name server passwd db */
# define MATCHMA	'\017'	/* match token in name server aliases db*/
...
EXTERN	char default_domain[YPMAXDOMAIN];
