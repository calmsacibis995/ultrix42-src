#ifndef lint
static	char	*sccsid = "@(#)ln03of.c	4.1	(ULTRIX)	7/2/90";
#endif lint
...
#define PLD	  '\113'	/* upper case K = ln03of partial line down */
#define PLU	  '\114'	/* upper case L = ln03of partial line up */
#define FLU	  '\115'	/* upper case M = ln03of full line up */
...
/* If the file stream is of the XIMAGE_FILE type this routine is called
   from ln03of.  The routine creates a sixel output stream to send
