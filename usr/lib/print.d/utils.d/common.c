#ifndef lint
static char *sccsid = "@(#)common.c	4.1	ULTRIX	7/2/90";
#endif
...
/*
 * common.c -- Routines and data common to all the line printer functions.
 */
 ...
 * 
 * 1.1  01/11/83 -- sccs
 * date and time created 83/11/01 20:54:02 by sccs
 * 
 * ***************************************************************
 * 
 * 1.2  12/12/84 -- root
 * added PP definition - lp
 * 
 * 
 * ***************************************************************
 * 
 * 1.3  17/07/86 -- root
 * Comments taken from: 1.3:
 * *** Working Pool Statistics ***: 1.3 86/07/02 17:41:19 hoffman 00004/00000/00253
 * 
 ...
 * *** Working Pool Statistics ***: 1.4 86/07/08 17:17:53 hoffman 00001/00000/00257
 * 
 ...
 * 
 * 1.5  17/05/88 -- thoms
 * Increased size of strings area for printcap
 * 
 * 
 * ***************************************************************
 * 
 * 1.6  20/05/88 -- thoms
 * Amended sizes to handle extra printcap entries.
 * Added limit pointer to check string area overflow (bp_lim)
 * 
 * 
 * ***************************************************************
 *
 ...
 * 1.8  02/07/90 -- sue
 * Changed name of rresvport to rresvport_lp to not conflict with
 * the libc.a routine.
 *
 * SCCS history end
 */
...
char	line[BUFSIZ];
char	pbuf[PRINTCAP_BUFSIZ];	/* buffer for printcap strings */

char	*bp = pbuf;	/* pointer into pbuf for pgetent() */
char	*bp_lim = &pbuf[PRINTCAP_BUFSIZ]; /* limit for bp */
