.\"
.\" @(#)tmac.e	4.1	(ULTRIX)	7/2/90
.\"
.\"------------------------------------------------------------------------
.\"
.\" tmac.e		- ME nroff / troff macros
.\"
.\"------------------------------------------------------------------------
.\"
.\" Last modified: 03/06/89	by Grant W. Sullivan
.\"	some comments added and updated
.\"	@f macro:
.\"	   rename itself to f@ before calling T#, then rename itself back to
.\"	   avoid possible loops when tables cross tage boundaries
.\"
.\"
.nr _0 \n(.c
.\"**********************************************************************
