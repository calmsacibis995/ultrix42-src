 ...
 * Modifications:
 *
 * 17-Dec-87	Andy Gadsby
 *	Modified to provide full 8 bit clean character masks. Increased
 *	regexp buffer sizes to allow 256 bits.
 *
 ***************************************************************************/
...
/*	expression command */
#include <stdio.h>
#define ESIZE	512	/* increased ESIZE to cope with 8 bit characters */
...
#define CMASK 0377	/* strip off unwanted bits for 8 bit character */
