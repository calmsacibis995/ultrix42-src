 ...
 *
 * IMPORTANT NOTE:
 *	This utility is guarrenteed to support all DEC disk drives
 *	only. The current DEC disk devices that are supported by 
 *	this utility are the (RZ55, RZ23, RZ22, and RRD40) disks.
 *	This utility may not work correctly with NON-DEC scsi disk 
 *	drives due to the differences in scsi from one vendor to
 *	the next.
 *
 ************************************************************************/
#include <stdio.h>
...
int fmt_defect_lists;
{
	...
	fp.fp_length = (dd.dd_header.rdd_hdr.defect_len0 & 0x00ff) +
