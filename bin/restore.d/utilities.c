# ifndef lint
static char *sccsid = "@(#)utilities.c	4.1    (ULTRIX)        7/2/90";
# endif not lint
 ...
 *
 * 11 Aug 89 -- lambert
 *	Modified printf's on link creation failure to be more readable.
 *
 * 19 Jan 87 -- map
 *	Changed definition of signal handler to void.
 *
 *  8 Sep 86 -- fries
