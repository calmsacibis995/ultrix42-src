...
# ifndef lint
static char *sccsid = "@(#)restore.c	4.1	(ULTRIX)	7/2/90";
# endif not lint
 ...
 *
 * 29 Jun 87 -- fries
 *	Changed code to not remove hard links if one is to be
 *	restored ontop an existing one. See SPR ICA-6547.
 *
 * 13 Feb 86 -- fries
	...
	char *symtabfile;
{
	...
	while (curfile.ino < maxino) {
		 ...
		 */
		/* KEEP test - added to fix bug ICA-6547 */
